...
#converting from Wperm2 to MJ/day
  ...
  select(datetime, day, month, phase, zone, burn_status, aspect, tree_name, temp_C, temp_K, LWout_wperm2, m2, Watz, LWout_MJperd, everything())
```
...
1.  Apply T_tree to whole snow depth

1.  Linear to ground (GND = 0 C)
