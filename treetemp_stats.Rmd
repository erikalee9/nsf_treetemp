...
```{r}
p_accum_gb_data <- full_hourly_gb %>%
  filter(zone == "PSZ", snow_phase == "accumulation")

p_abla_gb_data <- full_hourly_gb %>%
  filter(zone == "PSZ", snow_phase == "ablation")

t_accum_gb_data <- full_hourly_gb %>%
  filter(zone == "TSZ", snow_phase == "accumulation")

t_abla_gb_data <- full_hourly_gb %>%
