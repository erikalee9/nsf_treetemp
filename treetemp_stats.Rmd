...
filtered_pers_b_aspects <- pers_b_aspects %>%
  mutate(datetime = as.POSIXct(datetime, format=("%Y-%m-%d %H:%M:%S"))) %>%
  filter(datetime >= "2024-02-02 00:15:00" & datetime <= "2024-05-24 00:00:00") %>%
...
#GB/live T-test
## north
p_t_test_hourly_n_gbub_result <- t.test(p_n_full_hourly_gbdbub$gb_temp, p_n_full_hourly_gbdbub$ub_temp)

print(p_t_test_hourly_n_gbub_result)

t_t_test_hourly_n_gbub_result <- t.test(t_n_full_hourly_gbdbub$gb_temp, t_n_full_hourly_gbdbub$ub_temp)

print(t_t_test_hourly_n_gbub_result)

##south
p_t_test_hourly_s_gbub_result <- t.test(p_s_full_hourly_gbdbub$gb_temp, p_s_full_hourly_gbdbub$ub_temp)

print(p_t_test_hourly_s_gbub_result)

t_t_test_hourly_s_gbub_result <- t.test(t_s_full_hourly_gbdbub$gb_temp, t_s_full_hourly_gbdbub$ub_temp)

print(t_t_test_hourly_s_gbub_result)
```

```{r}
#DB/live T-test
## north
p_t_test_hourly_n_dbub_result <- t.test(p_n_full_hourly_gbdbub$db_temp, p_n_full_hourly_gbdbub$ub_temp)

print(p_t_test_hourly_n_dbub_result)

t_t_test_hourly_n_dbub_result <- t.test(t_n_full_hourly_gbdbub$db_temp, t_n_full_hourly_gbdbub$ub_temp)

print(t_t_test_hourly_n_dbub_result)

##south
p_t_test_hourly_s_dbub_result <- t.test(p_s_full_hourly_gbdbub$db_temp, p_s_full_hourly_gbdbub$ub_temp)

print(p_t_test_hourly_s_dbub_result)

t_t_test_hourly_s_dbub_result <- t.test(t_s_full_hourly_gbdbub$db_temp, t_s_full_hourly_gbdbub$ub_temp)

print(t_t_test_hourly_s_dbub_result)
```
...
gb_daynight_ns_temps <- full_hourly_gbdbub %>%
  select(1:7) %>%
  rename(date = day) %>%
