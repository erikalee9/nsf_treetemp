...
mean_dt_transb_radtree_comb$accu_netRad_wotree_MJd <- Reduce(`+`, mean_dt_transb_radtree_comb$total_mean_net_rad_wotree, accumulate = TRUE)x
```
...
mean_NR_acc_plot <- ggplot(data = accum_mean_data_bothzones) +
  ...
  labs(
   ...
   scale_color_manual(
   values = c("Tree LWout" = "#1B7837", 
               "Net LW" = "#D95F02", 
               "Net SW" = "#E6AB02", 
               "Total Net Radiation" = "black")) +
  scale_linetype_manual(
    values = c("Tree LWout" = "dashed", 
               "Net LW" = "solid", 
               "Net SW" = "solid", "Total Net Radiation" = "solid")
  ) +
  scale_shape_manual(
