...
persb_wx_15min <- persb_wx_15min %>%
  ...
  #don't know which columns are snow depths from Dan's weather station, need to figure this out then reorder/rename them
  select(datetime,TIMESTAMP, RECORD, Batt_volt, AirTC_Avg, WS_ms_Avg, WindDir, RH, SWin_Avg, SWout_Avg, SWalbedo_Avg, LWin_Avg, LWout_Avg, SWnet_Avg, LWnet_Avg, NR_Avg, everything() )
