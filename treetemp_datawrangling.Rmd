...
persb_north_diff_plot <- ggplot(persb_north_diff_long, aes(x = comparison, y = difference, fill = comparison)) +
  geom_boxplot() +
  theme_minimal() +
  labs(title = "Temperature Differences Between North Aspect Green and Dead Burned Trees",
       x = "Comparison",
...
persb_south_diff_plot <- ggplot(persb_south_diff_long, aes(x = comparison, y = difference, fill = comparison)) +
  geom_boxplot() +
  theme_minimal() +
  labs(title = "Temperature Differences Between South Aspect Green and Dead Burned Trees",
       x = "Comparison",
       y = "Temperature Difference (°C)",
       fill = "Tree Comparison")
...
##\*\* Need to think about if doing it this way makes sense or if I should be doing a timestep of sorts? Or an average? Because having this many outliers seems wrong.
