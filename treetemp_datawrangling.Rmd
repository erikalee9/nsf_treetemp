...
dtnt_gb_aspect_comparison <- ggplot(data = daily_final_gb_temps) +
  geom_line(aes(x = date, y = mean_north_temp), color = "green") +
  geom_line(aes(x = date, y = mean_south_temp), color = "red") +
  geom_line(aes(x = date, y = mean_charred_temp), color = "black") +
  geom_line(aes(x = date, y = mean_uncharred_temp), color = "grey") +
