...
PSZ_b_snowdepths_lineplot <- ggplot() + 
  ...
  geom_hline(yintercept = 0, linetype = "solid", color = "grey23", size = 0.3) +
  # Burned snow depth
  geom_line(data = persb_snowcamera_data_V2, aes(x = day, y = max_snowdepth_m, color = "Burned snow depth"), linetype = "solid", linewidth = 1) +
  # Unburned snow depth
...
TSZ_b_snowdepths_lineplot <- ggplot() + 
  ...
  geom_hline(yintercept = 0, linetype = "solid", color = "grey23", size = 0.3) +
  # Burned snow depth
  geom_line(data = transb_snowcamera_data_V2, aes(x = day, y = max_snowdepth_m, color = "Burned snow depth"), linetype = "solid", linewidth = 1) +
  # Unburned snow depth
