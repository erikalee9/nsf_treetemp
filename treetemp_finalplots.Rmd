...
```{r}
PSZ_b_snowdepths_lineplot <- ggplot(data = persb_snowcamera_data_V2) + 
  # Burned snow depth
  ...
  scale_color_manual(
    name = NULL,
    values = c("Mean Daily Air Temp" = "#D95F02", "Max Daily Snow Depth" = alpha("#2166AC", 0.7)),
    labels = c("Mean Daily Air Temp", "Max Daily Snow Depth")
  ) +
